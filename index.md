...
## Technical Skills
- <p align="justify">Identity and Access Management Solutions: PingFederate,PingAccess, Okta, PingOne, PingID, SailPoint, Microsoft EntraID, Active Directory Federation Services (ADFS), Auth0, IBM Security Access Manager (ISAM), and Tivoli Access Manager (TAM), Tivoli Federated Identity Manager (TFIM)</p>
