...
## Technical Skills
- <p align="justify">Identity and Access Management Solutions: PingFederate, PingAccess, PingOne, PingID, Okta, SailPoint, Microsoft EntraID, Active Directory Federation Services (ADFS), Auth0, IBM Security Access Manager (ISAM), and Tivoli Access Manager (TAM), Tivoli Federated Identity Manager (TFIM)</p>
...
- <p align="justify">Ticketing Systems: Service Now , Jira</p>
...
- <p align="justify">Scripting and Coding: JavaScript, PowerShell, Java, Python,.NET </p>
...
- <p align="justify">Implemented OAuth authentication for PingFederate and PingAccess Admin API and worked on the code development of SP and IDP adapters.</p> 
- <p align="justify">Worked on token exchange, client credentials, and authorization grant types. Worked on the development of the ping adapter. </p> 
- <p align="justify">Onboarded IDP (Identity Provider) and SP (Service Provider) connections and coordinated with vendors for configuration setup and testing.</p>
